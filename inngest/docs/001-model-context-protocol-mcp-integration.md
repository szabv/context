...
Description: Integrate AI development tools with Inngest using Model Context Protocol (MCP). Test functions, monitor execution, and debug workflows with Claude Code, Cursor, and other AI assistants.
...
```typescript
// Your function
handleSignup = inngest.createFunction(
  { id: "handle-signup" },
