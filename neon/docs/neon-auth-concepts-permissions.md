...
- [App/User RBAC Permissions HTML](https://neon.com/docs/neon-auth/concepts/permissions): The original HTML version of this documentation

> If you're looking for information about who can add or manage Neon Auth in your Neon project, see [Permissions overview](neon-auth-permissions-roles.md).
