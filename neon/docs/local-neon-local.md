...
```
   ...
   **Note**: For javascript applications
...
Connect using the Neon [serverless driver](serverless-serverless-driver.md).
...
| ------------------ | --------------------------------------------------------------------------------- | -------- | ----------------------------- |
| `NEON_API_KEY`     | Your Neon API key. [Manage API Keys](manage-api-keys.md)                       | Yes      | N/A                           |
