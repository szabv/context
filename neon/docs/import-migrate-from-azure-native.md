# Migrate from Neon Azure Native Integration

> This document guides Neon users through the process of migrating their databases from Azure Native Integration to Neon, detailing steps for data export, configuration, and import procedures.

## Source

- [Migrate from Neon Azure Native Integration HTML](https://neon.com/docs/import/migrate-from-azure-native): The original HTML version of this documentation
...
- You may have more than one organization in the Neon Console. [Review your organizations](import-migrate-from-azure-native.md#identify-your-organizations) to identify which one is Azure-managed and which is Neon-managed.
...
- You can [rename an organization](manage-orgs-manage.md#rename-an-organization) at any time.
...
Projects appear in your destination organization immediately after the transfer completes. For more details about project transfers, see [Transfer projects](manage-orgs-project-transfer.md).

## Update your organization configuration

After the transfer:

- Re-add any additional admins, members, or project collaborators who need access. See [Manage organization members](manage-orgs-manage.md#add-a-user-to-an-organization) for instructions.
- Verify that all projects appear in your Neon-managed organization.
- For [API keys](manage-api-keys.md), project-scoped and personal API keys remain the same after transfer. Organization API keys are tied to your Azure-managed organization, so if you use organization API keys, create new keys in your Neon-managed organization and update them in your applications, scripts, and integrations.
- Update any integrations or tooling that rely on organization-level identifiers.

## Delete your Azure-managed resource

   **Important**: Only delete your Azure resource after confirming all projects have been transferred. Deleting the Azure resource before transferring projects will permanently delete all projects and data in your Azure-managed organization.
...
If you need help, contact Neon Support through the Neon Console or visit the [support documentation](introduction-support.md).
