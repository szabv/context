...
1. [Create a Neon Project](guides-dotnet-entity-framework.md#create-a-neon-project)
2. [Create a .NET project and add dependencies](guides-dotnet-entity-framework.md#create-a-net-project-and-add-dependencies)
3. [Configure Entity Framework](guides-dotnet-entity-framework.md#configure-entity-framework)
4. [Run the application](guides-dotnet-entity-framework.md#run-the-application)
