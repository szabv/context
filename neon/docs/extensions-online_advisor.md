...
> The document details the "online_advisor" extension for Neon, which assists users in optimizing database performance by providing real-time recommendations and insights.

## Source

- [The online_advisor extension HTML](https://neon.com/docs/extensions/online_advisor): The original HTML version of this documentation
...
Please refer to the [Supported Postgres extensions](extensions-pg-extensions.md) page for the latest supported version of `online_advisor` on Neon.
