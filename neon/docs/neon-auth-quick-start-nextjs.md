...
Other frameworks:
- [Neon Auth for React](neon-auth-quick-start-react.md)
- [Neon Auth for JavaScript](neon-auth-quick-start-javascript.md)
  Sample project:
...
You can use these keys right away to get started, or [skip ahead](neon-auth-quick-start-nextjs.md#create-users-in-the-console-optional) to try out **user creation** in the Neon Console.
...
Paste the Neon Auth environment variables from [Step 2](neon-auth-quick-start-nextjs.md#get-your-neon-auth-keys) into your `.env.local` file.

Then `npm run dev` to start your dev server.

#### Test your integration

Go to [http://localhost:3000/handler/sign-up](http://localhost:3000/handler/sign-up) in your browser. Create a user or two, and you can see them [show up immediately](neon-auth-quick-start-nextjs.md#see-your-users-in-the-database) in your database.
...
Now you can [see your users in the database](neon-auth-quick-start-nextjs.md#see-your-users-in-the-database).
