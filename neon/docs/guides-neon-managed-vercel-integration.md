...
What you will learn:
- [The purpose of the Neon-Managed Integration](guides-neon-managed-vercel-integration.md#about-this-integration)
- [How to install it from Connectable Accounts](guides-neon-managed-vercel-integration.md#installation-steps)
- [How automated Preview Branching works](guides-neon-managed-vercel-integration.md#how-preview-branching-works)
- [How to manage environment variables and branch cleanup](guides-neon-managed-vercel-integration.md#managing-the-integration)
...
This opens the **Install Neon** modal where you can choose between two options. Select **Link Existing Neon Account**, then click **Continue**.
   ...
   **Tip**: Alternatively, if you're accessing this directly from the Vercel Marketplace, locate the **Connectable Accounts** section, find **Neon**, and click **Add**. This differs from the **Native Integrations** section in the Vercel Marketplace. 
...
Enable **Automatically delete obsolete Neon branches** during setup to remove preview branches automatically when the corresponding Git branch is deleted.
   ...
   **Note**: This Git-branch-based cleanup differs from the [Vercel-Managed Integration](guides-vercel-managed-integration.md), which deletes branches when deployments are deleted (either manually or automatically via Vercel's retention policies).
...
- [ ] [Test preview branching](guides-neon-managed-vercel-integration.md#how-preview-branching-works)
  Create a feature branch and push changes to verify preview deployments work correctly

- [ ] [Configure build commands](guides-neon-managed-vercel-integration.md#how-preview-branching-works)
  Add migration commands to Vercel's build settings if using an ORM like Prisma

- [ ] [Set up branch cleanup](guides-neon-managed-vercel-integration.md#branch-cleanup)
  Enable automatic cleanup or establish a manual cleanup process

- [ ] [Customize environment variables](guides-neon-managed-vercel-integration.md#environment-variables)
