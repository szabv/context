...
For more detail about organization-related methods, see [Organization API Keys](manage-orgs-api.md#api-keys).
...
Project-scoped API keys have [member-level access](manage-organizations.md#user-roles-and-permissions), meaning they **cannot** delete the project they are associated with. These keys:
