...
1. [Create a test branch](guides-branching-test-queries.md#create-a-test-branch)
2. [Test your query](guides-branching-test-queries.md#test-your-query)
3. [Delete the test branch](guides-branching-test-queries.md#delete-the-test-branch)
...
You can also create a test branch using the [Neon CLI](reference-cli-branches.md#create) or [Neon API](manage-branches.md#create-a-branch-with-the-api).
...
You can also delete a branch using the [Neon CLI](reference-cli-branches.md#delete) or [Neon API](manage-branches.md#delete-a-branch-with-the-api).
