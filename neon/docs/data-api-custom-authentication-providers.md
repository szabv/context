...
Related docs:
- [Getting started with Data API](data-api-get-started.md)
...
| ----------------------------------- | ------------------------------------------------------------------------------------------- |
| [Auth0](data-api-custom-authentication-providers.md#auth0)                     | `https://{YOUR_AUTH0_DOMAIN}/.well-known/jwks.json`                                         |
| [Clerk](data-api-custom-authentication-providers.md#clerk)                     | `https://{YOUR_CLERK_DOMAIN}/.well-known/jwks.json`                                         |
| [AWS Cognito](data-api-custom-authentication-providers.md#aws-cognito)         | `https://cognito-idp.{REGION}.amazonaws.com/{USER_POOL_ID}/.well-known/jwks.json`           |
| [Azure AD](data-api-custom-authentication-providers.md#azure-ad)               | `https://login.microsoftonline.com/{TENANT_ID}/discovery/v2.0/keys`                         |
| [Descope](data-api-custom-authentication-providers.md#descope)                 | `https://api.descope.com/{PROJECT_ID}/.well-known/jwks.json`                                |
| [Firebase/GCP](data-api-custom-authentication-providers.md#firebasegcp)        | `https://www.googleapis.com/service_accounts/v1/jwk/securetoken@system.gserviceaccount.com` |
| [Google Identity](data-api-custom-authentication-providers.md#google-identity) | `https://www.googleapis.com/oauth2/v3/certs`                                                |
| [Keycloak](data-api-custom-authentication-providers.md#keycloak)               | `https://{DOMAIN}/auth/realms/{REALM}/protocol/openid-connect/certs`                        |
| [PropelAuth](data-api-custom-authentication-providers.md#propelauth)           | `https://{YOUR_PROPEL_AUTH_URL}/.well-known/jwks.json`                                      |
| [Stack Auth](data-api-custom-authentication-providers.md#stack-auth)           | `https://api.stack-auth.com/api/v1/projects/{PROJECT_ID}/.well-known/jwks.json`             |
| [Stytch](data-api-custom-authentication-providers.md#stytch)                   | `https://test.stytch.com/v1/sessions/jwks/{PROJECT_ID}`                                     |
| [SuperTokens](data-api-custom-authentication-providers.md#supertokens)         | `{CORE_CONNECTION_URI}/.well-known/jwks.json`                                               |
| [WorkOS](data-api-custom-authentication-providers.md#workos)                   | `https://api.workos.com/sso/jwks/{CLIENT_ID}`                                               |
...
Then set up [Row-Level Security policies](data-api-get-started.md#create-a-table-with-rls) to control data access using the `auth.user_id()` function, which extracts the user ID from your JWT.
