...
> The document outlines the use of JSON data types in PostgreSQL within the Neon platform, detailing how to store, query, and manipulate JSON data effectively in a Neon-managed PostgreSQL database.
...
- [json_array_elements](functions-json_array_elements.md)
- [jsonb_array_elements](functions-jsonb_array_elements.md)
- [json_build_object](functions-json_build_object.md)
...
- [json_object](functions-json_object.md)
- [json_populate_record](functions-json_populate_record.md)
- [json_to_record](functions-json_to_record.md)
