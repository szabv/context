...
For more information about Neon's read replica feature, see [Read replicas](introduction-read-replicas.md).
...
Alternatively, you can create read replicas using the [Neon API](https://api-docs.neon.tech/reference/createprojectendpoint) or [Neon CLI](reference-cli-branches.md#create).
