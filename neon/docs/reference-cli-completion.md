...
> The document details the Neon CLI command completion feature, explaining how to enable and use shell command completion for efficient command-line operations within the Neon environment.
...
Before running the `completion` command, ensure that you have [installed the Neon CLI](reference-cli-install.md).
