...
> The document outlines the process of integrating WunderGraph with Neon, detailing steps for setting up a Neon database and configuring WunderGraph to interact with it effectively.

## Source

- [Use WunderGraph with Neon HTML](https://neon.com/docs/guides/wundergraph): The original HTML version of this documentation
...
This guide demonstrates setting up a full-stack app with Neon and WunderGraph, securely exposing Neon to your Next.js frontend in under 15 minutes. While WunderGraph and Neon are compatible with a variety of frontend clients, this demo focuses on using Next.js.
   ...
   **Info**: This guide is also available in video format: [Neon with WunderGraph video guide](guides-wundergraph.md#neon-with-wundergraph-video-guide).

## Prerequisites

- A [WunderGraph Cloud](https://cloud.wundergraph.com/) account
- A Neon project. See [Create a Neon project](manage-projects.md#create-a-project).
...
5. Write an operation that turns your Neon database into an API that exposes data that you can pass through the frontend. To do so, navigate to the `operations` folder inside your `.wundergraph` directory and create a new file called `Users.graphql`.
      ...
      **Info**: With WunderGraph you can write operations in either GraphQL or TypeScript.
