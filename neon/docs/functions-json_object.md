...
> The document details the usage of the Postgres `json_object()` function within Neon, explaining how to convert sets of key-value pairs into JSON objects.

## Source

- [Postgres json_object(https://neon.com/docs/functions/json_object): The original HTML version of this documentation
...
- [json_build_object](functions-json_build_object.md) - Similar to `json_object`, but allows for more flexibility in constructing the `JSON` object, as it can take a variable number of arguments in the form of key-value pairs.
