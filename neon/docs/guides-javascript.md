...
This section provides example JavaScript scripts that demonstrate how to connect to your Neon database and perform basic operations such as [creating a table](guides-javascript.md#create-a-table-and-insert-data), [reading data](guides-javascript.md#read-data), [updating data](guides-javascript.md#update-data), and [deleting data](guides-javascript.md#deleting-data).
...
- [Connect with Prisma](guides-prisma.md)
- [Connect with Drizzle ORM](guides-drizzle.md)
- [Connect with TypeORM](guides-typeorm.md)
- [Connect with Sequelize](guides-sequelize.md)
...
- [Connect with Bun](guides-bun.md)
- [Connect with Deno](guides-deno.md)
