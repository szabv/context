...
> This document outlines the process of performing schema migrations in Neon Postgres using Sequelize, detailing the steps for setting up and executing migrations within a Neon environment.

## Source

- [Schema migration with Neon Postgres and Sequelize HTML](https://neon.com/docs/guides/sequelize): The original HTML version of this documentation
...
- [Migrations with Neon and Sequelize](https://github.com/neondatabase/guide-neon-sequelize): Run Neon database migrations using Sequelize
