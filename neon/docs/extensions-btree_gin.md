...
> The document details the btree_gin extension for Neon, explaining its functionality in enabling GIN index support for B-tree indexable data types, enhancing query performance and indexing capabilities.

## Source

- [The btree_gin extension HTML](https://neon.com/docs/extensions/btree_gin): The original HTML version of this documentation
