...
> This document guides users on connecting a Hono application to a Neon database, detailing the necessary configuration steps and code adjustments required for seamless integration.
...
Add a `.env` file to your project directory and add your Neon connection string to it. You can find your connection details by clicking **Connect** on the Neon **Project Dashboard**. For more information, see [Connect from any application](connect-connect-from-any-app.md).
