...
> The document outlines the integration and application of AI technologies within Neon's infrastructure, detailing security measures and protocols to ensure safe and efficient AI utilization.

## Source

- [AI use in Neon HTML](https://neon.com/docs/security/ai-use-in-neon): The original HTML version of this documentation
...
For more details, see [AI features in the Neon SQL Editor](get-started-query-with-neon-sql-editor.md#ai-features).
...
For details on where to access Neon AI chat assistants, see [Neon AI chat assistance](introduction-support.md#neon-ai-chat-assistance).
