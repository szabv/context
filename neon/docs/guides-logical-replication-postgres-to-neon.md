...
> The document outlines the process for setting up logical replication to transfer data from a PostgreSQL database to Neon, detailing configuration steps and commands required for successful data synchronization.

## Source

- [Replicate data from Postgres to Neon HTML](https://neon.com/docs/guides/logical-replication-postgres-to-neon): The original HTML version of this documentation
...
- A destination Neon project. For information about creating a Neon project, see [Create a project](manage-projects.md#create-a-project).
