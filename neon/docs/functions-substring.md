...
> The document details the usage of the Postgres `substring()` function within Neon, explaining its syntax and parameters for extracting substrings from text data.

## Source

- [Postgres substring(https://neon.com/docs/functions/substring): The original HTML version of this documentation
