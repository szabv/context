...
> The document explains the usage of the Postgres `max()` function within Neon, detailing its syntax and application for retrieving the maximum value from a set of values in a database query.

## Source

- [Postgres max(https://neon.com/docs/functions/max): The original HTML version of this documentation
