...
> The "Partial Twin" documentation guides Neon users on how to perform partial PostgreSQL database dumps and restores using the Neon platform, enabling efficient data management and recovery processes.

## Source

- [Partial Twin HTML](https://neon.com/docs/guides/neon-twin-partial-pg-dump-restore): The original HTML version of this documentation

This workflow will create a partial Neon Twin using `pg_dump`, `pg_restore` and `psql`.

   **Note**: To use this workflow, you'll need the Postgres connection string for your Neon database. Follow our [Getting Started Guide](get-started-signing-up.md#sign-up) to learn how.
...
- [Automate Partial Data Dumps with PostgreSQL and GitHub Actions](https://neon.com/blog/automate-partial-data-dumps-with-postgresql-and-github-actions)
