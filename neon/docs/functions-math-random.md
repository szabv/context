...
> The document explains the usage of the Postgres `random()` function within Neon, detailing its syntax and examples for generating random numbers in SQL queries.

## Source

- [Postgres random(https://neon.com/docs/functions/math-random): The original HTML version of this documentation
