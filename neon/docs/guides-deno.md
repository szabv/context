...
- [Deploying your application locally with Deno Runtime](guides-deno.md#deploy-your-application-locally-with-deno-runtime)
- [Deploying your application with the Deno Deploy serverless platform](guides-deno.md#deploy-your-application-with-deno-deploy)
...
1. If you have not done so already, install the `deployctl` command-line utility, as described [above](guides-deno.md#install-the-deno-runtime-and-deployctl).
1. If you have not done so already, create the example `server.ts` application on your local machine, as described [above](guides-deno.md#create-the-example-application).
...
To delete your Neon project, refer to [Delete a project](manage-projects.md#delete-a-project).
