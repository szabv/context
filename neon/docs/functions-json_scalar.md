...
- [Postgres json_scalar(https://neon.com/docs/functions/json_scalar): The original HTML version of this documentation
...
- [json_build_object() function documentation](functions-json_build_object.md)
