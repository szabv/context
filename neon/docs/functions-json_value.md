...
> The document details the usage of the Postgres JSON_VALUE() function in Neon, explaining its syntax and application for extracting scalar values from JSON data within the database.

## Source

- [Postgres JSON_VALUE(https://neon.com/docs/functions/json_value): The original HTML version of this documentation
