...
- [Part 1: Create an S3 bucket to store backups](manage-backups-aws-s3-backup-part-1.md): Set up an AWS S3 bucket for storing backups
- [Part 2: Automate with GitHub Actions](manage-backups-aws-s3-backup-part-2.md): Schedule nightly backups with GitHub Actions and pg_dump
