...
- [Monitoring billing and usage](introduction-monitor-usage.md)
...
If you are unable to update your payment method, please [contact support](introduction-support.md).
...
If you are unable to update your billing email, please [contact support](introduction-support.md).

## Invoices

A Neon invoice includes the charges and the amount due for the billing period. For an explanation of what you've been billed for, see [Usage metrics](introduction-plans.md#usage-metrics).
...
## Change your plan
   ...
   **Important**: You cannot upgrade or downgrade to a [legacy plan](introduction-legacy-plans.md). If you're currently on a legacy plan, you can only upgrade or downgrade to one of the [current usage-based pricing plans](introduction-plans.md).
...
Changing your plan to one with lower usage allowances may affect the performance of your applications. To compare plan allowances, see [Neon plans](introduction-plans.md#neon-plans).
...
If you would like to delete your Neon account entirely, please refer to the steps described here: [Deleting your account](manage-accounts.md#delete-account).
