...
> The "Accounts" documentation for Neon details the procedures for managing user accounts, including account creation, access control, and permissions within the Neon platform.
...
**If you signed up with email,** it's not currently possible to switch to a social login. [Contact Support](introduction-support.md) and we'll help you out.
...
[Learn more about API keys](manage-api-keys.md)
...
See [Account Recovery](manage-account-recovery.md) for step-by-step instructions if you need to regain access to a Neon account.
