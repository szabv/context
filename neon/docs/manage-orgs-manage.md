...
After confirming, you'll be directed to your new organization's **Projects** page, where you can get started creating projects and inviting [members](manage-orgs-manage.md#invite-members).
...
Any member can invite external users to [collaborate](guides-project-collaboration-guide.md) on specific projects. For example, if you want to give limited access to a contractor.
...
For detailed information on pricing and plans, refer to [Neon plans](introduction-plans.md).
...
[See Neon plans for details.](introduction-plans.md)
