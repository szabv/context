...
- Before running the `set-context` command, ensure that you have [installed the Neon CLI](reference-neon-cli.md#install-the-neon-cli).
...
[Global options](reference-neon-cli.md#global-options) are also supported.
