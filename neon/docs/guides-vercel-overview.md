...
| Feature / Attribute     | [Vercel-Managed Integration](guides-vercel-managed-integration.md)                                 | [Neon-Managed Integration](guides-neon-managed-vercel-integration.md)                                     | [Manual Connection](guides-vercel-manual.md) |
| :---------------------- | :---------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------- | :---------------------------------------------- |
...
## Choose your integration path
   ...
   **Important** Do you need custom CI/CD control?: **If you want to build preview branching into your own CI/CD pipelines (e.g., via GitHub Actions)**, use a **[manual connection](guides-vercel-manual.md)** instead of the automated integrations below.
...
- **✅ Yes** → Use **[Neon-Managed Integration](guides-neon-managed-vercel-integration.md)**
- **❌ No** → Continue below
...
- **Through my Vercel account** → Use **[Vercel-Managed Integration](guides-vercel-managed-integration.md)**
- **Directly with Neon** → Use **[Neon-Managed Integration](guides-neon-managed-vercel-integration.md)**

---

## Integration options overview

- [Vercel-Managed Integration](guides-vercel-managed-integration.md): Create and manage Neon databases directly from your Vercel dashboard. Supports preview branches.
- [Neon-Managed Integration](guides-neon-managed-vercel-integration.md): Link an existing Neon project to Vercel and keep billing in Neon. Supports preview branches.
- [Manual Connection](guides-vercel-manual.md): Connect your Vercel project to a Neon database manually.
