...
- Optionally, you can install the [psql](https://www.postgresql.org/docs/current/logical-replication.html) command line utility for running commands in both Neon and Materialize. Alternatively, you can run commands from the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md) and Materialize **SQL Shell**, which require no installation or setup.
