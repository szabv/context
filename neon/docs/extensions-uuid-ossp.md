...
> The document explains how to use the uuid-ossp extension in Neon to generate universally unique identifiers (UUIDs) within PostgreSQL databases.
...
- `uuid_generate_v3(namespace uuid, name text)`:
  ...
  Available predefined namespace UUIDs are discussed in the [UUID Constants](extensions-uuid-ossp.md#uuid-constants) section below.
