...
What you will learn:
- [What connection pooling is and why it mattered for serverless](guides-vercel-connection-methods.md#the-core-change-connection-pooling)
- [The difference between "Classic Serverless" and Vercel's "Fluid compute"](guides-vercel-connection-methods.md#the-two-scenarios-classic-serverless-versus-fluid-compute)
- [How TCP, HTTP, and WebSocket connections compare on latency](guides-vercel-connection-methods.md#comparison-of-connection-methods)
- [Our recommendation for connecting from Vercel](guides-vercel-connection-methods.md#our-recommendation)
...
- [Benchmarking latency](guides-benchmarking-latency.md)
...
- **The solution (HTTP/WebSocket):** To solve this, Neon provides the [@neondatabase/serverless](serverless-serverless-driver.md) driver, which connects over HTTP or WebSockets. These protocols have _fewer setup roundtrips_ (~3-4), making them much faster _for the first query_.
...
Continue using the [@neondatabase/serverless](serverless-serverless-driver.md) driver. Its HTTP-based connection is optimized for low-latency "first queries," which is the most important metric in that environment.
