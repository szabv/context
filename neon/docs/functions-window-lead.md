...
- [Postgres lead(https://neon.com/docs/functions/window-lead): The original HTML version of this documentation
...
- [lag](functions-window-lag.md) - Access values from previous rows in a result set. Similar to `lead()` but looks behind in the partition instead of ahead.
