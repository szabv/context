...
- Before running a `vpc` command, ensure that you have [installed the Neon CLI](reference-cli-install.md).
...
You can use the `vpc` CLI command to manage [Private Networking](guides-neon-private-networking.md) configurations in Neon.

The `vpc` command includes subcommands for managing VPC endpoints and project-level VPC endpoint restrictions.

| Subcommand                               | Description                                    |
| :--------------------------------------- | :--------------------------------------------- |
| [endpoint](reference-cli-vpc.md#the-vpc-endpoint-subcommand) | Manage VPC endpoints                           |
| [project](reference-cli-vpc.md#the-vpc-project-subcommand)   | Manage project-level VPC endpoint restrictions |
...
In addition to the Neon CLI [global options](reference-neon-cli.md#global-options), the `vpc endpoint` subcommand supports these options:
...
In addition to the Neon CLI [global options](reference-neon-cli.md#global-options), the `vpc project` subcommand supports these options:
