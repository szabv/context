...
- [Connect to Neon from Knex](guides-knex.md#connect-to-neon-from-knex)
- [Use connection pooling with Knex](guides-knex.md#use-connection-pooling-with-knex)
- [Performance tips](guides-knex.md#performance-tips)
...
You can try this optimization yourself by downloading our [Get started with Knex example](guides-knex.md#examples) and running `npm run test`.
