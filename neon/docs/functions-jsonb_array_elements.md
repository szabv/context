...
> The document explains the usage of the `jsonb_array_elements()` function in PostgreSQL, detailing how it can be used within Neon to expand JSONB arrays into a set of JSONB values.

## Source

- [Postgres jsonb_array_elements(https://neon.com/docs/functions/jsonb_array_elements): The original HTML version of this documentation
