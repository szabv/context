...
- [Get started](data-api-get-started.md): Learn how to enable and use the Data API with RLS policies
- [Building a note-taking app](data-api-demo.md): See a complete example of the Data API with RLS in action
...
- [Simplify RLS with Drizzle](guides-rls-drizzle.md): Learn how to use Drizzle's crudPolicy function to simplify RLS policies
