...
1.  Connect to your Neon database using the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md) or a client like [psql](connect-query-with-psql-editor.md). Here is an example SQL statement to create a simple table including the object key, URL, user ID, and timestamp:
