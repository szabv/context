...
| ----------------------------------------------------------------------------------- | ---------------- | -------------------- |
| [Create an organization API key](manage-orgs-api.md#create-api-keys)                                  | ✅               | ❌                   |
| [Get a list of organization API keys](manage-orgs-api.md#list-api-keys)                               | ✅               | ✅                   |
| [Revoke an organization API key](manage-orgs-api.md#revoke-an-api-key)                                | ✅               | ✅                   |
| [Get organization details](manage-orgs-api.md#get-organization-details)                               | ✅               | ✅                   |
| [Get organization members details](manage-orgs-api.md#list-members)                                   | ✅               | ✅                   |
| [Get organization member details](manage-orgs-api.md#get-member-details)                              | ✅               | ✅                   |
| [Update the role for an organization member](manage-orgs-api.md#update-member-role)                   | ✅               | ✅                   |
| [Remove member from the organization](manage-orgs-api.md#remove-member)                               | ✅               | ❌                   |
| [Get organization invitation details](manage-orgs-api.md#list-invitations)                            | ✅               | ✅                   |
| [Create organization invitations](manage-orgs-api.md#create-invitations)                              | ✅               | ❌                   |
| [Transfer projects between organizations](manage-orgs-api.md#transfer-projects-between-organizations) | ✅               | ❌                   |
...
The key token is only displayed once at creation time. Copy it immediately and store it securely. If lost, you'll need to revoke the key and create a new one. For detailed instructions, see [Manage API Keys](manage-api-keys.md#create-an-organization-api-key).
...
Retrieves information about a specific member using their member ID (obtained from the [List members](manage-orgs-api.md#list-members) endpoint).
...
The API supports transferring projects between organizations. For detailed instructions and examples, see [Transfer projects to an organization](manage-orgs-project-transfer.md).
