...
> The document details the citext extension for Neon, which enables case-insensitive text handling in PostgreSQL databases by treating text values as case-insensitive for comparison and sorting operations.

## Source

- [The citext Extension HTML](https://neon.com/docs/extensions/citext): The original HTML version of this documentation
