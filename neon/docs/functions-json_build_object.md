...
> The document explains the usage of the Postgres `json_build_object()` function, detailing how it constructs JSON objects from key-value pairs within the Neon database environment.

## Source

- [Postgres json_build_object(https://neon.com/docs/functions/json_build_object): The original HTML version of this documentation
...
- [json_object](functions-json_object.md) - Builds a JSON object out of a text array.
