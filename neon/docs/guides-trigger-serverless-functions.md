...
- Creating a Neon project and enabling [Logical Replication](guides-logical-replication-guide.md).
...
- A Neon account. If you do not have one, see [Sign up](get-started-signing-up.md) for instructions.
