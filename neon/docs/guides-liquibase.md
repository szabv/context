...
> This document guides Neon users through integrating Liquibase for database schema management, detailing setup, configuration, and execution of schema changes within the Neon environment.

## Source

- [Get started with Liquibase and Neon HTML](https://neon.com/docs/guides/liquibase): The original HTML version of this documentation
...
- A Neon account. See [Sign up](get-started-signing-up.md).
...
1. Select **Databases** from the sidebar and create a database named `blog`. For instructions, see [Create a database](manage-databases.md#create-a-database).
1. Using the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md), add the following tables:
...
Learn how to use Liquibase with Neon's database branching feature to set up a developer workflow. See [Set up a developer workflow with Liquibase and Neon](guides-liquibase-workflow.md).
