...
What you will learn:
- [What the Vercel-Managed Integration is](guides-vercel-managed-integration.md#about-this-integration)
- [How to install it from the Vercel Marketplace](guides-vercel-managed-integration.md#installation-walkthrough)
- [How (and why) to enable automated Preview Branching](guides-vercel-managed-integration.md#enable-automated-preview-branching-recommended)
- [Where to manage billing and configuration](guides-vercel-managed-integration.md#managing--billing)

Related topics:
- [Neon-Managed Integration](guides-neon-managed-vercel-integration.md)
- [Manual Connections](guides-vercel-manual.md)
...
- Cleanup happens when deployments are deleted, which you can configure using [Vercel's retention policy settings](https://vercel.com/docs/deployment-retention). By default, Pre-Production Deployments (preview environments) are retained for 180 days:
   ...
   **Note**: This deployment-based cleanup differs from the [Neon-Managed Integration](guides-neon-managed-vercel-integration.md), which deletes branches when Git branches are deleted.
...
- Manage members / collaborators (handled through Vercel "Members", not the Neon Console) - (see [FAQ](guides-vercel-managed-integration.md#frequently-asked-questions-faq) for details)
...
- [Neon Console](manage-branches.md#delete-a-branch) - Individual or bulk deletion
- [Neon CLI](reference-cli-branches.md#delete) - Command line management
- [Neon API](manage-branches.md#delete-a-branch-with-the-api) - Programmatic cleanup

   **Note** Unused branches are archived: Branches you don't delete are eventually archived, consuming archive storage space. See [Branch archiving](guides-branch-archiving.md).
