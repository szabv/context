...
> The document explains the usage and syntax of the Postgres COUNT() function within Neon, detailing how to count rows in a database query effectively.

## Source

- [Postgres COUNT(https://neon.com/docs/functions/count): The original HTML version of this documentation
