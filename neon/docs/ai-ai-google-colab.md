...
> The document outlines how to integrate and use Neon with Google Colab, detailing steps for setting up a PostgreSQL database connection within the Colab environment for data analysis and machine learning tasks.

## Source

- [Google Colab HTML](https://neon.com/docs/ai/ai-google-colab): The original HTML version of this documentation
...
To perform the steps in this guide, you require a Neon database for storing vectors. You can use the ready-to-use `neondb` database or create your own. See [Create a database](manage-databases.md#create-a-database) for instructions.
