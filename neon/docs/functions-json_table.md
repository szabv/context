...
> The document explains the usage of the Postgres `JSON_TABLE()` function within Neon, detailing its syntax and application for transforming JSON data into a relational format.

## Source

- [Postgres JSON_TABLE(https://neon.com/docs/functions/json_table): The original HTML version of this documentation
