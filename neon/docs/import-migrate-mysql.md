...
- A Neon account and a project. See [Sign up](get-started-signing-up.md).
- A properly named database. For example, if you are migrating a database named `sakila`, you might want to create a database of the same name in Neon. See [Create a database](manage-databases.md#create-a-database) for instructions.
