...
- [Project permissions](neon-auth-permissions-roles.md#project-permissions) for managing Neon Auth as a feature in your Neon projects
- [App/user permissions](neon-auth-permissions-roles.md#appuser-permissions) for controlling what your app's users can do within your application.
...
For more information about organization roles and permissions, see [User roles and permissions](manage-organizations.md#user-roles-and-permissions).
...
For detailed information about implementing role-based access control for your application's users, see [App/User RBAC Permissions](neon-auth-concepts-permissions.md).
