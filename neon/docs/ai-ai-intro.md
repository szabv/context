...
- [AI concepts](ai-ai-concepts.md): Learn the fundamentals of embeddings and vector search for AI applications
- [pgvector extension](extensions-pgvector.md): Get started with pgvector for storing and querying vector embeddings

## AI frameworks and integrations

Build AI applications faster with these popular frameworks, tools, and services:

- [LangChain](ai-langchain.md): Create AI applications using LangChain with OpenAI and Neon
- [LlamaIndex](ai-llamaindex.md): Build RAG applications using LlamaIndex with OpenAI and Neon
- [Semantic Kernel](ai-semantic-kernel.md): Develop AI applications using Semantic Kernel with Azure OpenAI
- [Inngest](ai-inngest.md): Build reliable AI workflows with Inngest and Neon
- [app.build](ai-ai-app-build.md): Generate and deploy web applications using the open-source app.build agent
...
- [Scale with Neon](ai-ai-scale-with-neon.md): Learn how to scale your AI application with Autoscaling and Read Replicas
- [Optimize vector search](ai-ai-vector-search-optimization.md): Best practices for optimizing vector search performance
...
- [Vector search optimization](ai-ai-vector-search-optimization.md): Best practices for optimizing vector search performance
...
- [Google Colab guide](ai-ai-google-colab.md): Use Neon with Google Colab for ML experiments
- [Azure Data Studio Notebooks](ai-ai-azure-notebooks.md): A cloud-based Jupyter notebook service integrated with Azure Data Studio
