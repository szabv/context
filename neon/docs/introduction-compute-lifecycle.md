...
For information about configuring this setting, see [Edit a compute](manage-computes.md#edit-a-compute).
...
For more, see [Session context](reference-compatibility.md#session-context).
