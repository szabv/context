...
Related resources:
- [Instant restore](introduction-branch-restore.md)
...
To get started, see [Instant restore](introduction-branch-restore.md).
...
To learn how, see [Backups with pg_dump](manage-backup-pg-dump.md).
...
1. [Create an S3 bucket to store Postgres backups](manage-backups-aws-s3-backup-part-1.md)
2. [Set up a GitHub Action to perform nightly Postgres backups](manage-backups-aws-s3-backup-part-2.md)
