...
**Note**: These consumption metrics apply to Neon's [legacy pricing plans](introduction-legacy-plans.md). Metrics for Neon's current [usage-based pricing plans](introduction-about-billing.md) will be added in a future update.
...
For more information about this upcoming feature, see [Organizations](manage-organizations.md).
...
See [Details on setting a date range](guides-consumption-metrics.md#details-on-setting-a-date-range) for more info.
...
See [Details on pagination](guides-consumption-metrics.md#details-on-pagination) for more info.

## Details on setting a date range

This section applies to the following metrics output types: [Account-level aggregated metrics](guides-consumption-metrics.md#get-account-level-aggregated-metrics), and [Granular project-level metrics for your account](guides-consumption-metrics.md#get-granular-project-level-metrics-for-your-account).
...
This section applies to the following metrics output: [Granular project-level metrics for your account](guides-consumption-metrics.md#get-granular-project-level-metrics-for-your-account).
