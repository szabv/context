...
- [Claude Code plugin for Neon](ai-ai-claude-code-plugin.md): Install the Neon Claude Code plugin to give Claude access to Neon's APIs, Postgres workflows, and built-in Skills
