...
Other frameworks:
- [Neon Auth for Next.js](neon-auth-quick-start-nextjs.md)
...
You can use these keys right away to get started, or [skip ahead](neon-auth-quick-start-javascript.md#create-users-in-the-console-optional) to try out **user creation** in the Neon Console.
...
Paste the Neon Auth environment variables from [Step 2](neon-auth-quick-start-javascript.md#get-your-neon-auth-keys) into your `.env` or `.env.local` file.
...
1. Create a test user in the Console (see [Step 4](neon-auth-quick-start-javascript.md#create-users-in-the-console-optional)) and copy its ID.
...
Now you can [see your users in the database](neon-auth-quick-start-javascript.md#see-your-users-in-the-database).
