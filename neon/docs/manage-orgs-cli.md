...
> The document details how to manage organizations using the Neon CLI, including creating, listing, and deleting organizations, as well as managing organization members and roles.

## Source

- [Manage Organizations using the Neon CLI HTML](https://neon.com/docs/manage/orgs-cli): The original HTML version of this documentation
...
See [Auth - CLI](reference-cli-auth.md) to learn more.
...
See [Orgs - CLI](reference-cli-orgs.md) to learn more.
...
- [List projects](reference-cli-projects.md#list)
- [Create projects](reference-cli-projects.md#create)

See [Projects - CLI](reference-cli-projects.md) to learn more.
...
Sees [set-context - CLI](reference-cli-set-context.md) to learn more.
