...
- Before running the `operations` command, ensure that you have [installed the Neon CLI](reference-cli-install.md).
...
For information about operations in Neon, see [System operations](manage-operations.md).
...
| ------------- | --------------- |
| [list](reference-cli-operations.md#list) | List operations |
...
In addition to the Neon CLI [global options](reference-neon-cli.md#global-options), the `list` subcommand supports this option:
