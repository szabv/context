...
See more details about using this endpoint on the [Manage billing with consumption limits](guides-consumption-limits.md#retrieving-metrics-for-all-projects) page in our Platform integration guide.
