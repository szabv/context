...
> The document outlines the process for setting up logical replication of data from Neon to Fivetran, detailing the necessary configurations and steps to enable seamless data integration between the two platforms.

## Source

- [Replicate data with Fivetran HTML](https://neon.com/docs/guides/logical-replication-fivetran): The original HTML version of this documentation
...
1. If you are using Neon's **IP Allow** feature to limit IP addresses that can connect to Neon, add Fivetran's IPs to your allowlist in Neon.
   ...
   For instructions, see [Configure IP Allow](manage-projects.md#configure-ip-allow). You'll need to do this before you can validate your connection in the next step. If you are not using Neon's **IP Allow** feature, you can skip this step.
