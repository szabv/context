...
- [Update the email address](manage-accounts.md#update-personal-information)
- [Transfer project ownership](manage-orgs-project-transfer.md)
- [Add an admin](manage-orgs-manage.md#set-permissions) to your projects or organization
- [Update billing details](introduction-manage-billing.md)
