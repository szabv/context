...
To apply this schema to your Neon database, you can use the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md) in the web console or a database management tool like [psql](connect-query-with-psql-editor.md).
