...
What you will learn:
- [When to use manual connections over integrations](guides-vercel-manual.md#when-to-choose-this-path)
- [How to connect using environment variables](guides-vercel-manual.md#connection-steps)
- [Advanced CI/CD automation options](guides-vercel-manual.md#cicd-based-preview-branching-github-actions)
...
- [Automate branching with GitHub Actions](guides-branching-github-actions.md)
...
Looking for a full CI/CD recipe? See **[Automate branching with GitHub Actions](guides-branching-github-actions.md)**.
