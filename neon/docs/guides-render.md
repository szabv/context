...
> The document outlines the steps for integrating Neon Postgres with Render, detailing the configuration process to connect a Neon database to a Render application.

## Source

- [Use Neon Postgres with Render HTML](https://neon.com/docs/guides/render): The original HTML version of this documentation
...
- [Use Neon Postgres with Render](https://github.com/neondatabase/examples/tree/main/deploy-with-render): Connect a Neon Postgres database to your Node application deployed with Render
