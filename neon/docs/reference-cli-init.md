...
- Before running the `init` command, ensure that you have [installed the Neon CLI](reference-neon-cli.md#install-the-neon-cli).
...
This command supports [global options](reference-neon-cli.md#global-options) only.
