...
> The document details the usage of the Postgres `jsonb_object()` function within Neon, explaining how to construct JSON objects from key-value pairs in a database context.

## Source

- [Postgres jsonb_object(https://neon.com/docs/functions/jsonb_object): The original HTML version of this documentation
...
- [json_object](functions-json_object.md) - Same functionality as `jsonb_object`, but returns a `JSON` object instead of `JSONB`.
