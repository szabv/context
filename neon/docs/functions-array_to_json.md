...
> The document details the usage of the Postgres `array_to_json()` function within Neon, explaining how to convert PostgreSQL arrays into JSON format for data manipulation and storage.

## Source

- [Postgres array_to_json(https://neon.com/docs/functions/array_to_json): The original HTML version of this documentation
