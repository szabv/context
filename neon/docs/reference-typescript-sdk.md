...
Related resources:
- [Neon API Reference](reference-api-reference.md)
...
- [**API Keys:**](manage-api-keys.md) Create, list, and revoke API keys for secure access to the Neon API.
- [**Projects:**](manage-projects.md) Create, list, update, and delete Neon projects.
- [**Branches:**](manage-branches.md) Manage branches, including creation, deletion, restoration, and schema management.
- [**Databases:**](manage-databases.md) Create, list, update, and delete databases within your branches.
- [**Compute Endpoints:**](manage-computes.md) Manage compute endpoints, including creation, scaling, suspension, and restart.
- [**Roles:**](manage-roles.md) Create, list, update, and delete Postgres roles within your branches.
- [**Operations:**](manage-operations.md) Monitor and track the status of asynchronous operations performed on your Neon resources.
- [**Organizations:**](manage-orgs-api.md) Manage organization settings, API keys, and members (for Neon organizational accounts).
- [**Consumption Metrics:**](guides-consumption-metrics.md) Retrieve usage metrics for your account and projects to monitor resource consumption.

   **Tip** AI Rules available: Working with AI coding assistants? Check out our [AI rules for the Neon TypeScript SDK](ai-ai-rules-neon-typescript-sdk.md) to help your AI assistant generate better code when managing Neon resources programmatically.
...
- The `region_id` parameter specifies the cloud region where the project will be hosted. You can find the list of supported regions at [Neon Regions](introduction-regions.md).
...
- Compute Unit (CU) customization (optional): Control compute size using `autoscaling_limit_min_cu` and `autoscaling_limit_max_cu`. Refer to [Compute size and autoscaling configuration](manage-computes.md#compute-size-and-autoscaling-configuration) for available options.
...
- Branch & Project IDs: You can obtain these IDs from the [Neon Console](manage-branches.md#view-branches) or using SDK methods (e.g., [listProjectBranches](reference-typescript-sdk.md#list-branches), [listProjects](reference-typescript-sdk.md#list-projects)).
