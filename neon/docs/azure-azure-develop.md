...
- [Deploy Neon on Azure](azure-azure-deploy.md)

## Azure CLIs and SDKs for Neon

Azure provides an Azure-native CLI and SDKs for working with the Neon platform. In addition, the [Neon API](https://api-docs.neon.tech/reference/getting-started-with-neon-api), [CLI](reference-neon-cli.md), and [SDKs](reference-sdk.md) are also available to you.
...
- [Familiarize yourself with Neon](get-started-signing-up.md) — Get to know the Neon platform and features by stepping through our official getting started guides

## Migrate data to Neon on Azure

- [Migrating data to Neon](import-migrate-intro.md) — learn how to move data to Neon from various sources using different migration tools and methods

## Connect to Neon

- [Connecting to Neon](connect-connect-intro.md) – Learn about connecting to a Neon database
...
- [Semantic Kernel](ai-semantic-kernel.md) — Build AI RAG and agentic workflows with Semantic Kernel and Neon
...
- [Entity Framework with Neon](guides-dotnet-entity-framework.md) - Connect Entity Framework applications to Neon
- [Entity Framework schema migrations](guides-entity-migrations.md) - Schema migration with Neon and Entity Framework
