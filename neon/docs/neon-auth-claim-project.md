...
You can also find your current project ID here, as well as the JWKS URL you need to set up [RLS in your Neon Auth project](neon-auth-best-practices.md#enabling-row-level-security-rls).
