...
> The document explains the usage of the Postgres `date_trunc()` function within Neon, detailing how it truncates timestamps to specified precision levels, aiding in precise time-based data manipulation.

## Source

- [Postgres date_trunc(https://neon.com/docs/functions/date_trunc): The original HTML version of this documentation
