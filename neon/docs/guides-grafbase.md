...
> The document explains how to integrate Grafbase Edge Resolvers with Neon, detailing the steps to configure and deploy a serverless GraphQL API that interacts with Neon's PostgreSQL database.

## Source

- [Use Grafbase Edge Resolvers with Neon HTML](https://neon.com/docs/guides/grafbase): The original HTML version of this documentation
...
This guide describes how to create a GraphQL API using Grafbase and use Grafbase [Edge Resolvers](https://grafbase.com/docs/edge-gateway/resolvers) with the [Neon serverless driver](serverless-serverless-driver.md) to interact with your Neon database at the edge.
