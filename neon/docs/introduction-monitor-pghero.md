...
- Explain, analyze, and visualize queries
   ...
   **Note**: Neon does not currently support monitoring tools or platforms that require installing an agent on the Postgres host system, but please keep an eye on our [roadmap](introduction-roadmap.md) for future integrations that enable these monitoring options.
...
- Ensure that you have the [pg_stat_statements](extensions-pg_stat_statements.md) extension installed. PgHero uses it for query stats.
