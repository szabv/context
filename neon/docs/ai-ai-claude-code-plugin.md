...
| **neon-serverless**    | Teaches Claude how to configure [Neon's serverless Postgres driver](serverless-serverless-driver.md) and test connections.                                       |
...
| **add-neon-knowledge** | Gives Claude access to [Neon documentation](introduction.md) snippets and usage examples — the "Neon brain."                                                     |
...
- [AI Agents and Tools overview](ai-ai-agents-tools.md)
