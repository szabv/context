...
1. **clientMetadata**: Readable and writable from a [client](neon-auth-concepts-stack-app.md#client-vs-server).
2. **serverMetadata**: Readable and writable only from a [server](neon-auth-concepts-stack-app.md#client-vs-server).
