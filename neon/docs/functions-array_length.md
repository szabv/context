...
> The document details the usage of the Postgres `array_length()` function, which determines the number of elements in a specified dimension of an array, specifically within the context of Neon's database environment.

## Source

- [Postgres array_length(https://neon.com/docs/functions/array_length): The original HTML version of this documentation
