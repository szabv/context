...
> The plans described on this page are Neon's new usage-based pricing plans, introduced **August 14, 2025**. If you signed up for a paid plan earlier, you may still be on a [legacy plan](introduction-legacy-plans.md). To switch to a new plan, see [Change your plan](introduction-manage-billing.md#change-your-plan). Free plan users were automatically moved to the new Free plan described below, unless you signed up through **Azure Marketplace**.

   **Important**: If you signed up with Neon through **Azure Marketplace**, you are still on a [Neon legacy plan](introduction-legacy-plans.md) — this applies to both Free and paid plans.
...
Compare Neon's **Free**, **Launch**, and **Scale** plans.
   ...
   **Comingsoon** Building an agent platform?: For AI agent platforms that provision thousands of databases, Neon offers an **Agent Plan** with custom resource limits and credits for **your** free tier. [Learn more](introduction-agent-plan.md)

| Plan feature                                          | **Free**                       | **Launch**                           | **Scale**                                                                                         |
| ----------------------------------------------------- | ------------------------------ | ------------------------------------ | ------------------------------------------------------------------------------------------------- |
| [Price](introduction-plans.md#price)                                       | $0/month                       | $5/month minimum                     | $5/month minimum                                                                                  |
| [Who it's for](introduction-plans.md#who-its-for)                          | Prototypes and side projects   | Startups and growing teams           | Production-grade workloads and larger companies                                                   |
| [Projects](introduction-plans.md#projects)                                 | 100                            | 100                                  | 1,000 (can be increased on request)                                                               |
| [Branches](introduction-plans.md#branches)                                 | 10/project                     | 10/project                           | 25/project                                                                                        |
| [Extra branches](introduction-plans.md#extra-branches)                     | —                              | $1.50/branch-month (prorated hourly) | $1.50/branch-month (prorated hourly)                                                              |
| [Compute](introduction-plans.md#compute)                                   | 100 CU-hours/project           | $0.106/CU-hour                       | $0.222/CU-hour                                                                                    |
| [Autoscaling](introduction-plans.md#autoscaling)                           | Up to 2 CU (2 vCPU / 8 GB RAM) | Up to 16 CU (16 vCPU / 64 GB RAM)    | Up to 16 CU (fixed computes up to 56 vCPU / 224 GB RAM)                                           |
| [Scale to zero](introduction-plans.md#scale-to-zero)                       | After 5 min                    | After 5 min, can be disabled         | Configurable (1 minute to always on)                                                              |
| [Storage](introduction-plans.md#storage)                                   | 0.5 GB/project                 | $0.35/GB-month                       | $0.35/GB-month                                                                                    |
| [Public network transfer](introduction-plans.md#public-network-transfer)   | 5 GB included                  | 100 GB included, then $0.10/GB       | 100 GB included, then $0.10/GB                                                                    |
| [Monitoring](introduction-plans.md#monitoring)                             | 1 day                          | 3 days                               | 14 days                                                                                           |
| [Metrics/logs export](introduction-plans.md#metricslogs-export)            | —                              | —                                    | ✅                                                                                                |
| [Instant restore](introduction-plans.md#instant-restore)                   | —                              | $0.20/GB-month                       | $0.20/GB-month                                                                                    |
| [Restore window](introduction-plans.md#restore-window)                     | 6 hours, up to 1 GB-month      | Up to 7 days                         | Up to 30 days                                                                                     |
| [Private network transfer](introduction-plans.md#private-network-transfer) | —                              | —                                    | $0.01/GB                                                                                          |
| [Compliance and security](introduction-plans.md#compliance-and-security)   | —                              | Protected branches                   | SOC 2, ISO, GDPR, [HIPAA](security-hipaa.md), Protected branches, IP Allow, Private Networking |
| [Uptime SLA](introduction-plans.md#uptime-sla)                             | —                              | —                                    | ✅                                                                                                |
| [Support](introduction-plans.md#support)                                   | Community                      | Standard (billing issues only)       | Standard, Business, or Production                                                                 |

## Plan features

This section describes the features listed in the [Plan overview](introduction-plans.md#plan-overview) table.

   **Tip** Optimize your costs: Learn how to manage your Neon costs effectively with our [cost optimization guide](introduction-cost-optimization.md), which covers strategies for compute, storage, branches, and data transfer.
...
For **Launch** and **Scale**, the minimum monthly fee is $5. Usage for compute, storage, extra branches, and other features is billed at the published rates (see the [Plan overview](introduction-plans.md#plan-overview) table).
...
A project is a container for your database environment. It includes your database, branches, compute resources, and more. Similar to a Git repository that contains code, artifacts, and branches, a project contains all your database resources. Learn more about [Neon's object hierarchy](manage-overview.md).
...
- **Free**: 100 projects
- **Launch**: 100 projects
- **Scale**: 1,000 projects (soft limit — request more if needed via [support](introduction-support.md))

### ☑ Branches

Each Neon project is created with a [root branch](reference-glossary.md#root-branch), like the `main` branch in Git.  
Postgres objects — databases, schemas, tables, records, indexes, roles — are created on a branch.

You can create [child branches](reference-glossary.md#child-branch) for testing, previews, or development.
...
See [Extra branches](introduction-plans.md#extra-branches) for overage costs and [Storage](introduction-plans.md#storage) for how branch storage is billed.

> Projects can have multiple root branches, with limits based on your plan. See [Branch types: Root branch](manage-branches.md#root-branch) for details.

### ☑ Extra branches

On paid plans, you can create extra child branches. Extra branches beyond your plan's branch allowance (outlined [above](introduction-plans.md#-branches)) are billed in **branch-months**, metered hourly.
...
If you need more, contact [Sales](https://neon.com/contact-sales).
...
> All computes in your project count toward usage. Each branch has a read-write compute by default; [read replicas](reference-glossary.md#read-replica) add read-only computes.
...
- **[Root branches](reference-glossary.md#root-branch)**: billed on actual data size (_logical data size_)
- **[Child branches](reference-glossary.md#child-branch)**: billed on the minimum of the data changes since creation or the logical data size
...
> Public network transfer includes data sent via [logical replication](reference-glossary.md#logical-replication) to any destination, including other Neon databases.
...
See [Monitoring dashboard](introduction-monitoring-page.md) for details.

### ☑ Metrics/logs export

Export metrics and Postgres logs to [Datadog](guides-datadog.md) or any [OTel-compatible platform](guides-opentelemetry.md).  
...
You can change your [restore window](introduction-plans.md#restore-window) to control how much change history you retain. See [Instant restore](introduction-branch-restore.md) for details.

> The change history is a log of write operations in the form of Postgres [Write-Ahead Logs](reference-glossary.md#write-ahead-logging-wal).
...
The restore window is configurable. Shortening it can reduce [instant restore](introduction-plans.md#instant-restore) storage costs but limits how far back you can restore. See [Configure your restore window](manage-projects.md#configure-your-restore-window).
...
- GDPR
- CCPA
- HIPAA ([additional charge](security-hipaa.md))

Security features:

- [Protected branches](guides-protected-branches.md) — safeguards for critical data (available on **Launch** and **Scale**)
- [IP Allow](introduction-ip-allow.md) — restricts access to trusted IPs (available on **Scale**)
- [Private Networking](guides-neon-private-networking.md) — secure private connections via AWS PrivateLink (available on **Scale**)

### ☑ Uptime SLA

Guaranteed service availability is offered on the **Scale** plan. Contact [Sales](https://neon.com/contact-sales) for details.
...
See [Support](introduction-support.md) for details.
...
| **Metric**                             | **Description**                                                                                                                                                           |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Compute (CU-hour)**                  | Total compute usage in **CU-hours** (Compute Unit hours). [Learn more](introduction-plans.md#compute).                                                                 |
| **Extra branches (branch-month)**      | Number of extra branches beyond your plan allowance, metered hourly. [Learn more](introduction-plans.md#extra-branches).                                               |
| **Instant restore storage (GB-month)** | Storage used for **instant restore**, billed per GB-month. [Learn more](introduction-plans.md#instant-restore).                                                        |
| **Storage (root branches, GB-month)**  | Data storage for root branches, billed per GB-month. [Learn more](introduction-plans.md#storage).                                                                      |
| **Storage (child branches, GB-month)** | Data storage for child branches (minimum of delta or logical size), billed per GB-month. [Learn more](introduction-plans.md#storage).                                  |
| **Public network transfer (GB)**       | Outbound data transfer (egress) from your databases to the public internet. [Learn more](introduction-plans.md#public-network-transfer).                               |
| **Private network transfer (GB)**      | Bi-directional data transfer to and from your databases over private networking (e.g., AWS PrivateLink). [Learn more](introduction-plans.md#private-network-transfer). |
| **Minimum spend**                      | Minimum monthly fee for the plan before usage-based charges. [Learn more](introduction-plans.md#price).                                                                |
