...
Configure the Inngests Neon integration to trigger AI workflows from your Neon database changes [by following this guide](guides-trigger-serverless-functions.md).
