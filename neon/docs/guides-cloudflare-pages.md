...
> The document outlines the steps for integrating Neon with Cloudflare Pages, detailing the configuration process to connect a Neon database to a Cloudflare Pages application.

## Source

- [Use Neon with Cloudflare Pages HTML](https://neon.com/docs/guides/cloudflare-pages): The original HTML version of this documentation
...
We'll use the [Neon serverless driver](serverless-serverless-driver.md) to connect to the database and make queries.
...
We'll use the [Neon serverless driver](serverless-serverless-driver.md) to connect to the Neon database, so we first need to install it as a dependency:
...
- [Use Neon with Cloudflare Pages](https://github.com/neondatabase/examples/tree/main/deploy-with-cloudflare-pages): Connect a Neon Postgres database to your Cloudflare Pages web application
