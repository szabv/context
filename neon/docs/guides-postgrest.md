...
From the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md) or any SQL client such as [psql](connect-query-with-psql-editor.md), set up your database using the following queries:
