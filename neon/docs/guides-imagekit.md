...
1.  Connect to your Neon database using the [Neon SQL Editor](get-started-query-with-neon-sql-editor.md) or a client like [psql](connect-query-with-psql-editor.md). Create a table to store relevant details:
