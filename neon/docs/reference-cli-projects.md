...
- Before running the `projects` command, ensure that you have [installed the Neon CLI](reference-cli-install.md).
...
For information about projects in Neon, see [Projects](manage-projects.md).
...
| ----------------- | ---------------- |
| [list](reference-cli-projects.md#list)     | List projects    |
| [create](reference-cli-projects.md#create) | Create a project |
| [update](reference-cli-projects.md#update) | Update a project |
| [delete](reference-cli-projects.md#delete) | Delete a project |
| [get](reference-cli-projects.md#get)       | Get a project    |
...
In addition to the Neon CLI [global options](reference-neon-cli.md#global-options), the `projects` subcommand supports this option:
...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | :------: |
| `--context-file`             | [Context file](reference-cli-set-context.md#using-a-named-context-file) path and file name.                                                                                                                    | string  |          |
| `--block-public-connections` | Blocks public internet connections. See [Private Networking](guides-neon-private-networking.md).                                                                                                               | boolean |          |
| `--block-vpc-connections`    | Blocks connections using VPC. See [Private Networking](guides-neon-private-networking.md).                                                                                                                     | boolean |          |
| `--hipaa`                    | Enable the project for HIPAA. See [HIPAA Compliance](security-hipaa.md).                                                                                                                                       | boolean |          |
...
| `--org-id`                   | The organization ID where you want this project to be created. If unspecified, your [default organization](reference-glossary.md#default-organization) will be used.                                           | string  |          |
...
| `--cu`                       | The compute size for the default branch's primary compute. Could be a fixed size (e.g., "2") or a range delimited by a dash (e.g., "0.5-3").                                                                      | string  |          |
   ...
   **Note**: Neon projects created using the CLI use the default Postgres version, which is Postgres 17. To create a project with a different Postgres version, you can use the [Neon Console](manage-projects.md#create-a-project) or [Neon API](https://api-docs.neon.tech/reference/createproject).
...
- Create a project with a user-defined name in a specific region:
  ...
  ```
       ...
       **Tip**: The Neon CLI provides a `neon connection-string` command you can use to extract a connection uri programmatically. See [Neon CLI commands — connection-string](reference-cli-connection-string.md).
...
In addition to the Neon CLI [global options](reference-neon-cli.md#global-options), the `update` subcommand supports this option:
...
- Block connections from the public internet:
  ...
  This option is used with Neon's Private Networking feature to block access from the public internet. See [Private Networking — Restrict public internet access](guides-neon-private-networking.md#restrict-public-internet-access). You must specify the ID of you Neon project, as shown below.
...
Only [global options](reference-neon-cli.md#global-options) apply.
