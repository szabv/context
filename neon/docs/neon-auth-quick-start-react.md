...
You can use these keys right away to get started, or [skip ahead](neon-auth-quick-start-react.md#create-users-in-the-console-optional) to try out **user creation** in the Neon Console.
...
Paste the Neon Auth environment variables from the [Get your Neon Auth keys](neon-auth-quick-start-react.md#get-your-neon-auth-keys) section into your `.env.local` file.
...
Now you can [see your users in the database](neon-auth-quick-start-react.md#see-your-users-in-the-database).
