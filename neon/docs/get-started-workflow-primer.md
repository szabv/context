...
With Neon, you can work with your data just like you work with your code. The key is Neon's database [branching](guides-branching-intro.md) feature, which lets you instantly create branches of your data that you can include in your workflow — as many branches as you need.
...
- **Ready to use**: branches will have the parent branch's schema and all its data (you can also include data up to a certain point in time). If you're working with sensitive data, Neon also supports a [schema-only branching](guides-branching-schema-only.md) option.
...
Using the [Neon CLI](reference-neon-cli.md), you can create branches without leaving your editor or automate branch creation in your CI/CD pipeline.
...
- [Branching with the Neon CLI](guides-branching-neon-cli.md): Learn about branching with the Neon CLI
- [Neon CLI Reference](reference-neon-cli.md): Reference for all commands in the Neon CLI

### GitHub Actions

If you're using GitHub Actions for your CI workflows, Neon provides GitHub Actions for [creating](guides-branching-github-actions.md#create-branch-action), [deleting](guides-branching-github-actions.md#delete-branch-action), and [resetting](guides-branching-github-actions.md#reset-from-parent-action) branches — and there's also a [schema diff action](guides-branching-github-actions.md#schema-diff-action).
...
For more detailed documentation, see [Automate branching with GitHub Actions](guides-branching-github-actions.md).
