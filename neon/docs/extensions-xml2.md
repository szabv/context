...
> The document details the xml2 extension for Neon, explaining its functionality for parsing and querying XML data within PostgreSQL databases.

## Source

- [The xml2 extension HTML](https://neon.com/docs/extensions/xml2): The original HTML version of this documentation
