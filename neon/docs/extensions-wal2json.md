...
> The document details the wal2json plugin for Neon, explaining its role in converting PostgreSQL Write-Ahead Logging (WAL) data into JSON format for easier data processing and integration.

## Source

- [The wal2json plugin HTML](https://neon.com/docs/extensions/wal2json): The original HTML version of this documentation
...
The `wal2json` plugin is available in all Postgres versions supported by Neon. For the most up-to-date information on supported versions, please refer to the [list of all extensions](extensions-pg-extensions.md) available in Neon.
...
- [Manage logical replication in Neon - Decoder plugins](guides-logical-replication-manage.md#decoder-plugins)
