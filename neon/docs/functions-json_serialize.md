...
- [Postgres json_serialize(https://neon.com/docs/functions/json_serialize): The original HTML version of this documentation
...
- [json() function documentation](functions-json.md)
