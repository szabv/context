...
Refer to [Location of system root certificates](connect-connect-securely.md#location-of-system-root-certificates) below to find the path to system root certificates for your operating system.
