...
The easiest way to get started is with the [Neon GitHub integration](guides-neon-github-integration.md). It connects your Neon project to a GitHub repository, automatically creating the necessary `NEON_API_KEY` secret and `NEON_PROJECT_ID` variable for you. If you use the integration, you can skip the manual setup steps below.

### Manually set up your repository

1.  **Create a Neon API key.** For instructions, see [Create an API key](manage-api-keys.md#create-an-api-key).
