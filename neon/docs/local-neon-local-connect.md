...
Learn more about [branching in Neon](guides-branching-intro.md) and [Neon Local](local-neon-local.md).
...
- A [Neon account](https://neon.tech) and [API key](manage-api-keys.md) (for ephemeral branches only; you can also create new keys from the extension)
...
You'll need to make a few selections — organization, project, and then branch — before connecting. If you're new to Neon, this reflects our object hierarchy: organizations contain projects, and projects contain branches. [Learn more about how Neon organizes your data.](manage-overview.md)
...
As part of choosing your connection, you'll also be asked to choose driver type: **PostgreSQL** for most Postgres connections, or **Neon serverless** for edge/HTTP. [Read more about connection types](connect-choose-connection.md).
...
- **Reset from Parent Branch:** Instantly revert your branch to match the current state of its parent. Learn more about branch reset in [Docs: Branch Reset](guides-reset-from-parent.md). To reset a branch, right-click the branch in the **Database Schema** view and select **Reset from Parent Branch** from the context menu.
...
- [Neon Local documentation](local-neon-local.md)
- [Branching in Neon](guides-branching-intro.md)
- [Serverless driver](serverless-serverless-driver.md)
