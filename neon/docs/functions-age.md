...
> The document explains the usage of the Postgres `age()` function within Neon, detailing how it calculates the interval between two timestamps, which is useful for managing and querying temporal data.

## Source

- [Postgres age(https://neon.com/docs/functions/age): The original HTML version of this documentation
